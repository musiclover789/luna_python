...
<仅框架部分是免费、开源的，浏览器部分不开源也不免费，如果您介意收费，文档下方有免费获取授权方式>
...
您可以完成下面的任何一个，联系作者获取免费授权

1、完善当前readme.md 中英文双语版本；

2、写python版本文档

3、发布完整项目示例、到您自己的csdn、知乎、等任意平台，保留帖子2周以上

4、完善、修复代码bug、新增功能，并得到认可。
